...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, discriminator, discriminator_global, discriminator_decoder, transformer, num_classes, num_queries,
                 aux_loss=False):
        ...
        self.discriminator_decoder = discriminator_decoder
    ...
    def forward(self, samples: NestedTensor, targets: list = None, target_domain=False):
        ...
        # if target_domain:
        #     feat_base1, _ = features[0].decompose()
        ...
        domain_p_decoder = self.discriminator_decoder(grad_reverse(hs))
        # if target_domain:
        #     return d_pixel, domain_p, domain_p_decoder
        ...
        return out, targets, features, memory, hs, d_pixel, domain_p, domain_p_decoder
