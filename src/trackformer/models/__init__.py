...
from .netD_decoder import build_decoder_discriminator
...
def build_model(args):
    ...
    discriminator_decoder = build_decoder_discriminator(args)
    ...
    tracking_kwargs = {
        'target_domain_track_query_threshold': args.target_domain_track_query_threshold,
    ...
    if args.deformable:
        raise NotImplementedError('Deformable DETR is not supported yet.')
        ...
        if args.tracking:
            if args.masks:
                raise NotImplementedError('Masks are not supported yet.')
